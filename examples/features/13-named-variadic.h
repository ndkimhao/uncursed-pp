...
#define UNCURSED_PP_DEFINE_GRADIENT_PUT_0(v, p0, e0) v, e0
#define UNCURSED_PP_DEFINE_GRADIENT_BODY(name, STOPS, e0) static const int name[] = { UNCURSED_PP_KW_SPREAD STOPS };
...
#define UNCURSED_PP_DEFINE_GRADIENT_ERROR_TOO_MANY_ARGUMENTS(kw, excess)
#define UNCURSED_PP_DEFINE_GRADIENT_STOPS(...) UNCURSED_PP_DEFINE_GRADIENT_ERROR_TOO_MANY_ARGUMENTS(~)
