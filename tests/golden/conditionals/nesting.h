...
#define CURSEDPP_TRIAGE_EACH1(r, d, e) BOOST_PP_IIF(BOOST_PP_EQUAL(BOOST_PP_TUPLE_ELEM(0, e), 1), CURSEDPP_TRIAGE_THEN2, CURSEDPP_TRIAGE_ELSE1)(BOOST_PP_TUPLE_ELEM(1, e), BOOST_PP_TUPLE_ELEM(0, e))
